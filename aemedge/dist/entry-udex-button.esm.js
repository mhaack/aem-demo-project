import { e as g, l as a, f as B, r as y, s as L, p as r, b as O, c as P, U as D, i as F, g as M, h as V, j as T, k as G, m as w, d as I, a as U } from "./parameters-bundle.css-D8cwbzFi.js";
import { s as J, e as f, g as Y, i as E, a as z, b as q, I as X, r as $ } from "./Icon-DMcPBkxp.js";
import { B as Z, a as K, b as Q } from "./i18n-defaults-CHsb9ete.js";
const oo = (t) => {
  const o = t;
...
y("@ui5/webcomponents-theming", "sap_horizon", async () => L);
...
let W = !1, x = null, n = _ = class extends D {
  ...
  _onclick(o) {
    ...
    e && this._isSubmit && e.triggerFormSubmit(this), e && this._isReset && e.triggerFormReset(this), G() && ((u = this.getDomRef()) == null || u.focus());
  }
  _onmousedown(o) {
  ...
  _onkeydown(o) {
    p(o, "button"), (E(o) || z(o)) && this._setActiveState(!0);
  }
  _onkeyup(o) {
    (E(o) || z(o)) && this.active && this._setActiveState(!1);
  }
  _onfocusout() {
    this.nonInteractive || (this.active && this._setActiveState(!1), w() && (this.focused = !1));
  }
  _onfocusin(o) {
    this.nonInteractive || (p(o, "button"), w() && (this.focused = !0));
  }
  _setActiveState(o) {
  ...
  static async onDefine() {
    _.i18nBundle = await q("@ui5/webcomponents");
  }
};
d([

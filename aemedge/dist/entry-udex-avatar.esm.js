import { n as q, e as u, l as t, f as g, r as y, s as X, o as P, p as i, b as A, c as D, U as G, q as U, m as j, d as N, a as W } from "./parameters-bundle.css-D8cwbzFi.js";
import { s as K, c as C, e as Z, b as J, a as Q, i as w, I as Y } from "./Icon-DMcPBkxp.js";
import { A as aa } from "./i18n-defaults-CHsb9ete.js";
let T;
...
class I {
  ...
  static register(r, e) {
    let o = r;
    q(o) && (o = o.getDomRef()), o instanceof HTMLElement ? ra(o, e) : console.warn("Cannot register ResizeHandler for element", r);
  }
  /**
   * @public
  ...
  static deregister(r, e) {
    let o = r;
    q(o) && (o = o.getDomRef()), o instanceof HTMLElement ? ea(o, e) : console.warn("Cannot deregister ResizeHandler for element", r);
  }
}
function oa(a, r, e) {
...
y("@ui5/webcomponents", "sap_horizon", async () => K);
...
C(ka, { pathData: O, ltr: za, collection: ya, packageName: Aa });
P();
...
let c = p = class extends G {
  ...
  static async onDefine() {
    p.i18nBundle = await J("@ui5/webcomponents");
  }
  get tabindex() {
  ...
  async onAfterRendering() {
    await U(), this.initials && !this.icon && this._checkInitials();
  }
  onEnterDOM() {
    j() && this.setAttribute("desktop", ""), this.initialsContainer && I.register(this.initialsContainer, this._handleResizeBound);
  }
  onExitDOM() {
...
n([
  i({ type: f, defaultValue: f.S })
], c.prototype, "size", void 0);
n([
  i({ type: f, defaultValue: f.S })
], c.prototype, "_size", void 0);
n([
  i({ type: _, defaultValue: _.Accent6 })
...
y("@ui5/webcomponents-theming", "sap_horizon", async () => X);
y("@udex/web-components", "sap_horizon", async () => W);

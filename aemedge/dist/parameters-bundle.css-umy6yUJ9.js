var Xt = {}, Zt = Xt.hasOwnProperty, Xr = Xt.toString, Kt = Zt.toString, Zr = Kt.call(Object), ut = function(t) {
  var e, r;
  return !t || Xr.call(t) !== "[object Object]" ? !1 : (e = Object.getPrototypeOf(t), e ? (r = Zt.call(e, "constructor") && e.constructor, typeof r == "function" && Kt.call(r) === Zr) : !0);
}, Kr = /* @__PURE__ */ Object.create(null), Yt = function(t, e, r, o) {
  var _, a, i, n, s, d, u = arguments[2] || {}, l = 3, p = arguments.length, c = arguments[0] || !1, v = arguments[1] ? void 0 : Kr;
  for (typeof u != "object" && typeof u != "function" && (u = {}); l < p; l++)
    if ((s = arguments[l]) != null)
      for (n in s)
        _ = u[n], i = s[n], !(n === "__proto__" || u === i) && (c && i && (ut(i) || (a = Array.isArray(i))) ? (a ? (a = !1, d = _ && Array.isArray(_) ? _ : []) : d = _ && ut(_) ? _ : {}, u[n] = Yt(c, arguments[1], d, i)) : i !== v && (u[n] = i));
  return u;
};
const it = function(t, e) {
  return Yt(!0, !1, ...arguments);
}, Yr = () => new Promise((t) => {
...
}, ro = () => typeof document > "u" ? null : Jt('meta[name="ui5-shared-resources"]', document.head, to), j = (t, e) => {
  const r = t.split(".");
  let o = ro();
  if (!o)
    return e;
...
let pe, oo = "";
const Fe = /* @__PURE__ */ new Map(), J = j("Runtimes", []), _o = () => {
  if (pe === void 0) {
    pe = J.length;
    const t = eo;
    J.push({
      ...t,
      alias: oo,
      description: `Runtime ${pe} - ver ${t.version}`
    });
  }
}, V = () => pe, Qt = (t, e) => {
  const r = `${t},${e}`;
  ...
  return Fe.set(r, d), d;
}, ao = () => J, io = typeof document > "u", we = (t, e) => e ? `${t}|${e}` : t, pt = (t) => t === void 0 ? !0 : Qt(V(), parseInt(t)) === 1, ye = (t, e, r = "", o) => {
  const _ = typeof t == "string" ? t : t.content, a = V();
  if (document.adoptedStyleSheets && !_e()) {
    const i = new CSSStyleSheet();
    i.replaceSync(_), i._ui5StyleId = we(e, r), o && (i._ui5RuntimeIndex = a, i._ui5Theme = o), document.adoptedStyleSheets = [...document.adoptedStyleSheets, i];
  } else {
    const i = {};
    i[e] = r, o && (i["data-ui5-runtime-index"] = a, i["data-ui5-theme"] = o), Jr(_, i);
  }
}, no = (t, e, r = "", o) => {
  const _ = typeof t == "string" ? t : t.content, a = V();
  if (document.adoptedStyleSheets && !_e()) {
    const i = document.adoptedStyleSheets.find((n) => n._ui5StyleId === we(e, r));
    if (!i)
      return;
    if (!o)
      i.replaceSync(_ || "");
      ...
      (i._ui5Theme !== o || pt(n)) && (i.replaceSync(_ || ""), i._ui5RuntimeIndex = String(a), i._ui5Theme = o);
    }
  } else {
    ...
    if (!o)
      ...
      (i.getAttribute("data-ui5-theme") !== o || pt(n)) && (i.textContent = _ || "", i.setAttribute("data-ui5-runtime-index", String(a)), i.setAttribute("data-ui5-theme", o));
    }
  }
}, Se = (t, e = "") => {
  if (io)
  ...
  return document.adoptedStyleSheets && !_e() ? !!r || !!document.adoptedStyleSheets.find((o) => o._ui5StyleId === we(t, e)) : !!r;
}, so = (t, e = "") => {
  var r;
  if (document.adoptedStyleSheets && !_e())
    document.adoptedStyleSheets = document.adoptedStyleSheets.filter((o) => o._ui5StyleId !== we(t, e));
  else {
    const o = document.querySelector(`head > style[${t}="${e}"]`);
    (r = o == null ? void 0 : o.parentElement) == null || r.removeChild(o);
  }
}, er = (t, e, r = "", o) => {
  Se(e, r) ? no(t, e, r, o) : ye(t, e, r, o);
}, co = (t, e) => {
  if (t === void 0)
    return e;
  if (e === void 0)
...
}, lo = /* @__PURE__ */ new Map(), S = (t) => lo.get(t), uo = {
  ...
  const t = S("OpenUI5Support");
  (!t || !t.isOpenUI5Detected()) && ho(), mo();
}, ho = () => {
  Se("data-ui5-font-face") || ye(uo, "data-ui5-font-face");
}, mo = () => {
  Se("data-ui5-font-face-override") || ye(po, "data-ui5-font-face-override");
}, fo = {
  packageName: "@ui5/webcomponents-base",
  ...
  try {
    if (t.startsWith(".") || t.startsWith("/"))
      ...
      o && Bo(o) ? e = r.toString() : e = ko(r.toString(), window.location.href);
    }
...
const So = () => (ae(), k.theme), xo = () => (ae(), k.themeRoot), Ao = () => (ae(), k.language), Io = () => (ae(), k.fetchDefaultLanguage), To = () => (ae(), k.noConflict), ge = /* @__PURE__ */ new Map();
ge.set("true", !0);
ge.set("false", !1);
const Fo = () => {
  ...
  t.forEach((e, r) => {
    ...
    o === 0 || o === r.split("sap-ui-").length || ht(r, e, "sap");
  }), t.forEach((e, r) => {
    r.startsWith("sap-ui") && ht(r, e, "sap-ui");
  });
}, Ho = (t) => {
  const e = t.split("@")[1];
  return wo(e);
}, Lo = (t, e) => t === "theme" && e.includes("@") ? e.split("@")[0] : e, ht = (t, e, r) => {
  const o = e.toLowerCase(), _ = t.split(`${r}-`)[1];
  ge.has(e) && (e = ge.get(o)), _ === "theme" ? (k.theme = Lo(_, e), e && e.includes("@") && (k.themeRoot = Ho(e))) : k[_] = e;
}, Uo = () => {
  const t = S("OpenUI5Support");
  ...
  typeof document > "u" || vt || (Fo(), Eo(), Uo(), vt = !0);
}, mt = 10;
class Po {
  constructor() {
  ...
  process(e) {
    ...
    for (r = this.shift(); r; ) {
      const _ = o.get(r) || 0;
      if (_ > mt)
        throw new Error(`Web component processed too many times this task, max allowed is: ${mt}`);
      e(r), o.set(r, _ + 1), r = this.shift();
    }
  }
}
const tr = j("Tags", /* @__PURE__ */ new Map()), nt = /* @__PURE__ */ new Set();
let U = /* @__PURE__ */ new Map(), Ee;
const rr = -1, $o = (t) => {
  nt.add(t), tr.set(t, V());
}, Mo = (t) => nt.has(t), Ro = () => [...nt.values()], No = (t) => {
  let e = tr.get(t);
  e === void 0 && (e = rr), U.has(e) || U.set(e, /* @__PURE__ */ new Set()), U.get(e).add(t), Ee || (Ee = setTimeout(() => {
    Do(), U = /* @__PURE__ */ new Map(), Ee = void 0;
  }, 1e3));
}, Do = () => {
  const t = ao(), e = V(), r = t[e];
  let o = "Multiple UI5 Web Components instances detected.";
  t.length > 1 && (o = `${o}
Loading order (versions before 1.1.0 not listed): ${t.map((_) => `
${_.description}`).join("")}`), [...U.keys()].forEach((_) => {
    let a, i;
    _ === rr ? (a = 1, i = {
...
"${r.description}" failed to define ${U.get(_).size} tag(s) as they were defined by a runtime of ${n} version "${i.description}": ${[...U.get(_)].sort().join(", ")}.`, a > 0 ? o = `${o}
...
}, or = /* @__PURE__ */ new Set(), Oo = (t) => {
  or.add(t);
}, zo = (t) => or.has(t), st = /* @__PURE__ */ new Set(), Wo = new I(), z = new Po();
let N, ve, He, ce;
const _r = async (t) => {
  z.add(t), await Vo();
}, ar = (t) => {
  Wo.fireEvent("beforeComponentRender", t), st.add(t), t._render();
}, jo = (t) => {
  z.remove(t), st.delete(t);
}, Vo = async () => {
  ce || (ce = new Promise((t) => {
    window.requestAnimationFrame(() => {
      z.process(ar), ce = null, t(), He || (He = setTimeout(() => {
        He = void 0, z.isEmpty() && Xo();
      }, 200));
    });
  })), await ce;
}, Go = () => N || (N = new Promise((t) => {
  ve = t, window.requestAnimationFrame(() => {
    z.isEmpty() && (N = void 0, t());
  });
}), N), qo = () => {
  const t = Ro().map((e) => customElements.whenDefined(e));
  return Promise.all(t);
}, ir = async () => {
  await qo(), await Go();
}, Xo = () => {
  z.isEmpty() && ve && (ve(), ve = void 0, N = void 0);
}, Zo = async (t) => {
  st.forEach((e) => {
    const r = e.constructor, o = r.getMetadata().getTag(), _ = zo(r), a = r.getMetadata().isLanguageAware(), i = r.getMetadata().isThemeAware();
    (!t || t.tag === o || t.rtlAware && _ || t.languageAware && a || t.themeAware && i) && _r(e);
  }), await ir();
}, nr = new I(), sr = "themeRegistered", Ko = (t) => {
  nr.attachEvent(sr, t);
}, Yo = (t) => nr.fireEvent(sr, t), ft = /* @__PURE__ */ new Map(), dr = /* @__PURE__ */ new Map(), Jo = /* @__PURE__ */ new Map(), cr = /* @__PURE__ */ new Set(), be = /* @__PURE__ */ new Set(), lr = (t, e, r) => {
  dr.set(`${t}/${e}`, r), cr.add(t), be.add(e), Yo(e);
}, ur = async (t, e, r) => {
  const o = `${t}_${e}_${r || ""}`, _ = ft.get(o);
  if (_ !== void 0)
    return _;
  if (!be.has(e)) {
    const s = [...be.values()].join(", ");
    return console.warn(`You have requested a non-registered theme ${e} - falling back to ${fe}. Registered themes are: ${s}`), Le(t, fe);
  }
  const [a, i] = await Promise.all([
    Le(t, e),
    r ? Le(t, r, !0) : void 0
  ]), n = co(a, i);
  return n && ft.set(o, n), n;
}, Le = async (t, e, r = !1) => {
  const _ = (r ? Jo : dr).get(`${t}/${e}`);
  if (!_) {
  ...
  return a._ || a;
}, pr = () => cr, Qo = (t) => be.has(t), D = /* @__PURE__ */ new Set(), e_ = () => {
  ...
  if (e && e.length >= 2) {
    ...
    if (r = r.replace(/\\"/g, '"'), r.charAt(0) !== "{" && r.charAt(r.length - 1) !== "}")
      try {
        ...
        D.has("decode") || (console.warn("Malformed theme metadata string, unable to decodeURIComponent"), D.add("decode"));
        return;
      }
    try {
      return JSON.parse(r);
    } catch {
      D.has("parse") || (console.warn("Malformed theme metadata string, unable to parse JSON"), D.add("parse"));
    }
  }
}, r_ = (t) => {
  let e, r;
  try {
    ...
    D.has("object") || (console.warn("Malformed theme metadata Object", t), D.add("object"));
    return;
  }
  return {
    themeName: e,
  ...
  if (e)
    return r_(e);
}, o_ = new I(), __ = "themeLoaded", a_ = (t) => o_.fireEvent(__, t);
let Ue;
const vr = () => (Ue === void 0 && (Ue = xo()), Ue), i_ = (t) => `${vr()}Base/baseLib/${t}/css_variables.css`, n_ = async (t) => {
  const e = document.querySelector(`[sap-ui-webcomponents-theme="${t}"]`);
  e && document.head.removeChild(e), await Qr(i_(t), { "sap-ui-webcomponents-theme": t });
}, ee = "@ui5/webcomponents-theming", s_ = () => pr().has(ee), d_ = async (t) => {
  if (!s_())
    return;
  const e = await ur(ee, t);
  e && er(e, "data-ui5-theme-properties", ee, t);
}, c_ = () => {
  so("data-ui5-theme-properties", ee);
}, l_ = async (t, e) => {
  const o = [...pr()].map(async (_) => {
    if (_ === ee)
      return;
    const a = await ur(_, t, e);
    a && er(a, `data-ui5-component-properties-${V()}`, _);
  });
  ...
  if (r && r.isOpenUI5Detected()) {
    ...
    return await n_(t), Je();
}, hr = async (t) => {
  const e = await u_(t);
  !e || t !== e.themeName ? await d_(t) : c_();
  const r = Qo(t) ? t : e && e.baseThemeName;
  await l_(r || fe, e && e.themeName === t ? t : void 0), a_(t);
};
let Pe;
const Ae = () => (Pe === void 0 && (Pe = So()), Pe), p_ = () => {
  var e, r;
  const t = Ae();
  return v_(t) ? !t.startsWith("sap_horizon") : !((r = (e = Je()) == null ? void 0 : e.baseThemeName) != null && r.startsWith("sap_horizon"));
}, v_ = (t) => bo.includes(t);
let mr = !1, le;
const h_ = new I(), m_ = async () => {
  if (le !== void 0)
    return le;
  const t = async (e) => {
    ...
    Ko(f_), _o();
    const r = S("OpenUI5Support"), o = r ? r.isOpenUI5Detected() : !1, _ = S("F6Navigation");
    r && await r.init(), _ && !o && _.init(), await Yr(), await hr(Ae()), r && r.attachListeners(), vo(), go(), e(), mr = !0, await h_.fireEventAsync("boot");
  };
  return le = new Promise(t), le;
}, f_ = (t) => {
  const e = Ae();
  mr && t === e && hr(e);
}, $e = /* @__PURE__ */ new Map(), Me = /* @__PURE__ */ new Map(), gt = (t) => {
  if (!$e.has(t)) {
    const e = g_(t.split("-"));
    $e.set(t, e);
  }
  ...
  return Me.get(t);
}, g_ = (t) => t.map((e, r) => r === 0 ? e.toLowerCase() : e.charAt(0).toUpperCase() + e.slice(1).toLowerCase()).join(""), b_ = (t) => {
  ...
  return "default";
}, gr = (t) => t instanceof HTMLSlotElement ? t.assignedNodes({ flatten: !0 }).filter((e) => e instanceof HTMLElement) : [t], C_ = (t) => t.reduce((e, r) => e.concat(gr(r)), []);
let B_, bt = {
  include: [/^ui5-/],
  exclude: []
};
const Re = /* @__PURE__ */ new Map(), br = () => B_, Qe = (t) => {
  if (!Re.has(t)) {
    const e = bt.include.some((r) => t.match(r)) && !bt.exclude.some((r) => t.match(r));
    Re.set(t, e);
  }
  return Re.get(t);
}, Cr = (t) => {
...
class k_ {
  ...
  static validatePropertyValue(e, r) {
    return r.multiple && e ? e.map((_) => Ct(_, r)) : Ct(e, r);
  }
  /**
   ...
   */
  getAttributesList() {
    return this.getPropertiesList().filter(this.hasAttribute.bind(this)).map(fr);
  }
  /**
...
}, w_ = (t, e) => (t && gr(t).forEach((r) => {
  if (!(r instanceof e.type))
    throw new Error(`The element is not of type ${e.type.toString()}`);
}), t);
class y_ extends HTMLElement {
}
customElements.get("ui5-static-area") || customElements.define("ui5-static-area", y_);
const S_ = () => j("CustomStyle.eventProvider", new I()), x_ = "CustomCSSChange", dt = (t) => {
  S_().attachEvent(x_, t);
}, A_ = () => j("CustomStyle.customCSSFor", {});
dt((t) => {
  Zo({ tag: t });
});
const I_ = (t) => {
  const e = A_();
  return e[t] ? e[t].join("") : "";
}, T_ = 10, Ne = (t) => Array.isArray(t) ? t.filter((e) => !!e).flat(T_).map((e) => typeof e == "string" ? e : e.content).join(" ") : typeof t == "string" ? t : t.content, he = /* @__PURE__ */ new Map();
dt((t) => {
  he.delete(`${t}_normal`);
});
const Br = (t, e = !1) => {
  const r = t.getMetadata().getTag(), o = `${r}_${e ? "static" : "normal"}`, _ = S("OpenUI5Enablement");
  if (!he.has(o)) {
    let a, i = "";
    if (_ && (i = Ne(_.getBusyIndicatorStyles())), e)
      a = Ne(t.staticAreaStyles);
    else {
      const n = I_(r) || "";
      a = `${Ne(t.styles)} ${n}`;
    }
...
const F_ = (t, e = !1) => {
  ...
  if (!me.has(o)) {
    const _ = Br(t, e), a = new CSSStyleSheet();
    a.replaceSync(_), me.set(o, [a]);
  }
  return me.get(o);
}, et = (t, e = !1) => {
  let r;
  ...
  if (document.adoptedStyleSheets && !_e() ? _.adoptedStyleSheets = F_(o, e) : r = Br(o, e), o.renderer) {
    o.renderer(a, _, r, e, { host: t });
    return;
  }
  o.render(a, _, r, e, { host: t });
}, E_ = "--_ui5_content_density", H_ = (t) => getComputedStyle(t).getPropertyValue(E_), kr = (t) => t.matches(":dir(rtl)") ? "rtl" : "ltr", ue = "ui5-static-area-item", L_ = "data-sap-ui-integration-popup-content";
class Y extends HTMLElement {
   ...
   */
  update() {
    this._rendered && (this.updateAdditionalProperties(), et(this.ownerElement, !0));
  }
  ...
  _updateContentDensity() {
    H_(this.ownerElement) === "compact" ? (this.classList.add("sapUiSizeCompact"), this.classList.add("ui5-content-density-compact")) : (this.classList.remove("sapUiSizeCompact"), this.classList.remove("ui5-content-density-compact"));
  }
  _updateDirection() {
    if (this.ownerElement) {
      const e = kr(this.ownerElement);
      e === "rtl" ? this.setAttribute("dir", e) : this.removeAttribute("dir");
    }
  }
  _updateAdditionalAttrs() {
    this.setAttribute(ue, ""), this.setAttribute(L_, "");
  }
  /**
   ...
   */
  async getDomRef() {
    return this.updateAdditionalProperties(), this._rendered || (this._rendered = !0, et(this.ownerElement, !0)), await ir(), this.shadowRoot;
  }
  static getTag() {
    const e = Cr(ue);
    return e ? `${ue}-${e}` : ue;
  ...
  static createInstance() {
    return customElements.get(Y.getTag()) || customElements.define(Y.getTag(), Y), document.createElement(this.getTag());
  }
}
const U_ = [], P_ = (t) => U_.some((e) => t.startsWith(e)), tt = /* @__PURE__ */ new WeakMap(), $_ = (t, e, r) => {
  const o = new MutationObserver(e);
  tt.set(t, o), o.observe(t, r);
}, M_ = (t) => {
  const e = tt.get(t);
  e && (e.disconnect(), tt.delete(t));
}, R_ = [
  "value-changed",
  "click"
];
let De;
const N_ = (t) => R_.includes(t), D_ = (t) => {
  const e = wr();
  return !(typeof e != "boolean" && e.events && e.events.includes && e.events.includes(t));
}, wr = () => (De === void 0 && (De = To()), De), O_ = (t) => {
  const e = wr();
  return N_(t) ? !1 : e === !0 ? !0 : !D_(t);
}, z_ = [
  "disabled",
  "title",
  "hidden",
  "role",
  "draggable"
], Bt = (t) => z_.includes(t) || t.startsWith("aria") ? !0 : ![
  HTMLElement,
  Element,
  Node
].some((r) => r.prototype.hasOwnProperty(t)), kt = (t, e) => {
  ...
  const e = t.constructor, r = e.getMetadata().getPureTag(), o = e.getUniqueDependencies().map((_) => _.getMetadata().getPureTag()).filter(Qe);
  return Qe(r) && o.push(r), o;
};
let j_ = 0;
const wt = /* @__PURE__ */ new Map(), Oe = /* @__PURE__ */ new Map();
function q(t) {
  this._suppressInvalidation || (this.onInvalidation(t), this._changedState.push(t), _r(this), this._invalidationEventProvider.fireEvent("invalidate", { ...t, target: this }));
}
class ie extends HTMLElement {
  constructor() {
    super();
    const e = this.constructor;
    this._changedState = [], this._suppressInvalidation = !0, this._inDOM = !1, this._fullyConnected = !1, this._childChangeListeners = /* @__PURE__ */ new Map(), this._slotChangeListeners = /* @__PURE__ */ new Map(), this._invalidationEventProvider = new I(), this._componentStateFinalizedEventProvider = new I();
    let r;
   ...
   */
  get _id() {
    return this.__id || (this.__id = `ui5wc_${++j_}`), this.__id;
  }
  render() {
  ...
  async connectedCallback() {
    ...
    this._inDOM = !0, r && (this._startObservingDOMChildren(), await this._processChildren()), this._inDOM && (ar(this), this._domRefReadyPromise._deferredResolve(), this._fullyConnected = !0, this.onEnterDOM());
  }
  /**
  ...
  disconnectedCallback() {
    ...
    this._inDOM = !1, r && this._stopObservingDOMChildren(), this._fullyConnected && (this.onExitDOM(), this._fullyConnected = !1), this.staticAreaItem && this.staticAreaItem.parentElement && this.staticAreaItem.parentElement.removeChild(this.staticAreaItem), jo(this);
  }
  /**
  ...
  _startObservingDOMChildren() {
    ...
    $_(this, this._processChildren.bind(this), i);
  }
  /**
   * @private
   */
  ...
  async _updateSlots() {
    ...
    const n = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), d = _.map(async (l, p) => {
      ...
      if (v === void 0) {
        if (c !== "default") {
          const m = Object.keys(r).join(", ");
          console.warn(`Unknown slotName: ${c}, ignoring`, l, `Valid values are: ${m}`);
        }
        return;
      }
      if (v.individualSlots) {
        const m = (n.get(c) || 0) + 1;
        n.set(c, m), l._individualSlot = `${c}-${m}`;
      }
      if (l instanceof HTMLElement) {
        const m = l.localName;
        if (m.includes("-") && !P_(m)) {
          if (!customElements.get(m)) {
            const Gr = customElements.whenDefined(m);
            let de = wt.get(m);
            de || (de = new Promise((qr) => setTimeout(qr, 1e3)), wt.set(m, de)), await Promise.race([Gr, de]);
          }
          customElements.upgrade(l);
        }
      }
      if (l = e.getMetadata().constructor.validateSlotValue(l, v), yt(l) && v.invalidateOnChildChange) {
        const m = this._getChildChangeListener(c);
        m && l.attachInvalidate.call(l, m);
      }
      l instanceof HTMLSlotElement && this._attachSlotChange(l, c);
      const h = v.propertyName || c;
      s.has(h) ? s.get(h).push({ child: l, idx: p }) : s.set(h, [{ child: l, idx: p }]);
    });
    ...
    for (const [l, p] of Object.entries(r)) {
      const c = p.propertyName || l;
      kt(a.get(c), this._state[c]) || (q.call(this, {
        type: "slot",
        name: i.get(c),
        reason: "children"
      }), u = !0);
   ...
   */
  _onChildChange(e, r) {
    this.constructor.getMetadata().shouldInvalidateOnChildChange(e, r.type, r.name) && q.call(this, {
      type: "slot",
      name: e,
      reason: "childchange",
      child: r.target
  ...
  attributeChangedCallback(e, r, o) {
    ...
    if (this._doNotSyncAttributes.has(e))
      return;
    const a = this.constructor.getMetadata().getProperties(), i = e.replace(/^ui5-/, ""), n = gt(i);
  ...
  _updateAttribute(e, r) {
    ...
    let n = a.validator;
    const s = fr(e), d = this.getAttribute(s);
  ...
  _render() {
    ...
    this._suppressInvalidation = !0, this.onBeforeRendering(), this._componentStateFinalizedEventProvider.fireEvent("componentStateFinalized"), this._suppressInvalidation = !1, this._changedState = [], e._needsShadowDOM() && et(this), this.staticAreaItem && this.staticAreaItem.update(), r && this._assignIndividualSlotsToChildren(), this.onAfterRendering();
  }
  /**
   * @private
   */
  ...
  fireEvent(e, r, o = !1, _ = !0) {
    const a = this._fireEvent(e, r, o, _), i = gt(e);
   ...
   */
  get effectiveDir() {
    return Oo(this.constructor), kr(this);
  }
  /**
  ...
  getStaticAreaItemDomRef() {
    ...
    return this.staticAreaItem || (this.staticAreaItem = Y.createInstance(), this.staticAreaItem.setOwnerElement(this)), this.staticAreaItem.parentElement || Jt("ui5-static-area").appendChild(this.staticAreaItem), this.staticAreaItem.getDomRef();
  }
  /**
   * @private
   */
  static _generateAccessors() {
    ...
    for (const [_, a] of Object.entries(o)) {
      if (Bt(_) || console.warn(`"${_}" is not a valid property name. Use a name that does not collide with DOM APIs`), a.type === Boolean && a.defaultValue)
      ...
      i != null && i.get && (s = i.get), Object.defineProperty(e, _, {
        ...
        set(d) {
          ...
          const c = a.type;
          let v = a.validator;
          const h = s ? s.call(this) : this._state[_];
          c && c.isDataTypeClass && (v = c), v ? u = !v.valuesAreEqual(h, d) : Array.isArray(h) && Array.isArray(d) && a.multiple && a.compareValues ? u = !kt(h, d) : u = h !== d, u && (n ? n.call(this, d) : this._state[_] = d, q.call(this, {
            type: "property",
            name: _,
            newValue: d,
            oldValue: h
    ...
    if (r) {
      ...
      for (const [a, i] of Object.entries(_)) {
        Bt(a) || console.warn(`"${a}" is not a valid property name. Use a name that does not collide with DOM APIs`);
        const n = i.propertyName || a;
   ...
   */
  static async define() {
    await m_(), await Promise.all([
      this.whenDependenciesDefined(),
      this.onDefine()
    ]);
    const e = this.getMetadata().getTag(), r = Mo(e), o = customElements.get(e);
    return o && !r ? No(e) : o || (this._generateAccessors(), $o(e), customElements.define(e, this)), this;
  }
  /**
  ...
  static getMetadata() {
    ...
    const o = it({}, ...e);
    return this._metadata = new k_(o), this._metadata;
  }
}
ie.metadata = {};
ie.styles = "";
const yt = (t) => "isUI5Element" in t, V_ = (t = {}) => (e) => {
 ...
 */
var ze;
const Ce = window, W = Ce.trustedTypes, St = W ? W.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Be = "$lit$", x = `lit$${(Math.random() + "").slice(9)}$`, ct = "?" + x, G_ = `<${ct}>`, $ = document, te = () => $.createComment(""), re = (t) => t === null || typeof t != "object" && typeof t != "function", yr = Array.isArray, Sr = (t) => yr(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", We = `[ 	
\f\r]`, X = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, xt = /-->/g, At = />/g, H = RegExp(`>|${We}(?:([^\\s"'>=/]+)(${We}*=${We}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), It = /'/g, Tt = /"/g, xr = /^(?:script|style|textarea|title)$/i, Ar = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), q_ = Ar(1), X_ = Ar(2), M = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), Ft = /* @__PURE__ */ new WeakMap(), P = $.createTreeWalker($, 129, null, !1);
function Ir(t, e) {
...
const Tr = (t, e) => {
  ...
  for (let n = 0; n < r; n++) {
    ...
    for (; p < s.length && (i.lastIndex = p, u = i.exec(s), u !== null); )
      p = i.lastIndex, i === X ? u[1] === "!--" ? i = xt : u[1] !== void 0 ? i = At : u[2] !== void 0 ? (xr.test(u[2]) && (_ = RegExp("</" + u[2], "g")), i = H) : u[3] !== void 0 && (i = H) : i === H ? u[0] === ">" ? (i = _ ?? X, l = -1) : u[1] === void 0 ? l = -2 : (l = i.lastIndex - u[2].length, d = u[1], i = u[3] === void 0 ? H : u[3] === '"' ? Tt : It) : i === Tt || i === It ? i = H : i === xt || i === At ? i = X : (i = H, _ = void 0);
    const c = i === H && t[n + 1].startsWith("/>") ? " " : "";
    a += i === X ? s + G_ : l >= 0 ? (o.push(d), s.slice(0, l) + Be + s.slice(l) + x + c) : s + x + (l === -2 ? (o.push(void 0), n) : c);
  }
  return [Ir(t, a + (t[r] || "<?>") + (e === 2 ? "</svg>" : "")), o];
};
class oe {
  constructor({ strings: e, _$litType$: r }, o) {
    ...
    this.parts = [];
    let a = 0, i = 0;
    const n = e.length - 1, s = this.parts, [d, u] = Tr(e, r);
    if (this.el = oe.createElement(d, o), P.currentNode = this.el.content, r === 2) {
      ...
      if (_.nodeType === 1) {
        if (_.hasAttributes()) {
          ...
          for (const p of _.getAttributeNames())
            if (p.endsWith(Be) || p.startsWith(x)) {
              const c = u[i++];
              if (l.push(p), c !== void 0) {
                const v = _.getAttribute(c.toLowerCase() + Be).split(x), h = /([.?@])?(.*)/.exec(c);
                s.push({ type: 1, index: a, name: h[2], strings: v, ctor: h[1] === "." ? Er : h[1] === "?" ? Hr : h[1] === "@" ? Lr : ne });
              } else
        ...
        if (xr.test(_.tagName)) {
          const l = _.textContent.split(x), p = l.length - 1;
          if (p > 0) {
            _.textContent = W ? W.emptyScript : "";
            for (let c = 0; c < p; c++)
              _.append(l[c], te()), P.nextNode(), s.push({ type: 2, index: ++a });
            _.append(l[p], te());
          }
        }
        ...
        if (_.data === ct)
          ...
          let l = -1;
          for (; (l = _.data.indexOf(x, l + 1)) !== -1; )
            s.push({ type: 7, index: a }), l += x.length - 1;
        }
      a++;
    }
  }
...
function R(t, e, r = t, o) {
  var _, a, i, n;
  if (e === M)
    return e;
  let s = o !== void 0 ? (_ = r._$Co) === null || _ === void 0 ? void 0 : _[o] : r._$Cl;
  const d = re(e) ? void 0 : e._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== d && ((a = s == null ? void 0 : s._$AO) === null || a === void 0 || a.call(s, !1), d === void 0 ? s = void 0 : (s = new d(t), s._$AT(t, r, o)), o !== void 0 ? ((i = (n = r)._$Co) !== null && i !== void 0 ? i : n._$Co = [])[o] = s : r._$Cl = s), s !== void 0 && (e = R(t, s._$AS(t, e.values), s, o)), e;
}
class Fr {
  constructor(e, r) {
  ...
  u(e) {
    var r;
    const { el: { content: o }, parts: _ } = this._$AD, a = ((r = e == null ? void 0 : e.creationScope) !== null && r !== void 0 ? r : $).importNode(o, !0);
    P.currentNode = a;
    let i = P.nextNode(), n = 0, s = 0, d = _[0];
    for (; d !== void 0; ) {
      if (n === d.index) {
        let u;
        d.type === 2 ? u = new G(i, i.nextSibling, this, e) : d.type === 1 ? u = new d.ctor(i, d.name, d.strings, this, e) : d.type === 6 && (u = new Ur(i, this, e)), this._$AV.push(u), d = _[++s];
      }
      n !== (d == null ? void 0 : d.index) && (i = P.nextNode(), n++);
    }
    return P.currentNode = $, a;
  }
  v(e) {
    let r = 0;
...
class G {
  constructor(e, r, o, _) {
    var a;
    this.type = 2, this._$AH = f, this._$AN = void 0, this._$AA = e, this._$AB = r, this._$AM = o, this.options = _, this._$Cp = (a = _ == null ? void 0 : _.isConnected) === null || a === void 0 || a;
  }
  get _$AU() {
    var e, r;
  ...
  _$AI(e, r = this) {
    e = R(this, e, r), re(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== M && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : Sr(e) ? this.T(e) : this._(e);
  }
  k(e) {
  ...
  _(e) {
    this._$AH !== f && re(this._$AH) ? this._$AA.nextSibling.data = e : this.$($.createTextNode(e)), this._$AH = e;
  }
  g(e) {
    var r;
    const { values: o, _$litType$: _ } = e, a = typeof _ == "number" ? this._$AC(e) : (_.el === void 0 && (_.el = oe.createElement(Ir(_.h, _.h[0]), this.options)), _);
    if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === a)
      this._$AH.v(o);
    else {
      const i = new Fr(a, this), n = i.u(this.options);
      i.v(o), this.$(n), this._$AH = i;
    }
  }
  _$AC(e) {
    let r = Ft.get(e.strings);
    return r === void 0 && Ft.set(e.strings, r = new oe(e)), r;
  }
  T(e) {
    ...
    let o, _ = 0;
    for (const a of e)
      _ === r.length ? r.push(o = new G(this.k(te()), this.k(te()), this, this.options)) : o = r[_], o._$AI(a), _++;
...
class ne {
  constructor(e, r, o, _, a) {
    this.type = 1, this._$AH = f, this._$AN = void 0, this.element = e, this.name = r, this._$AM = _, this.options = a, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = f;
  }
  get tagName() {
  ...
  _$AI(e, r = this, o, _) {
    ...
    let i = !1;
    if (a === void 0)
      e = R(this, e, r, 0), i = !re(e) || e !== this._$AH && e !== M, i && (this._$AH = e);
    else {
      const n = e;
      let s, d;
      for (e = a[0], s = 0; s < a.length - 1; s++)
        d = R(this, n[o + s], r, s), d === M && (d = this._$AH[s]), i || (i = !re(d) || d !== this._$AH[s]), d === f ? e = f : e !== f && (e += (d ?? "") + a[s + 1]), this._$AH[s] = d;
    }
    i && !_ && this.j(e);
  }
  j(e) {
...
const Z_ = W ? W.emptyScript : "";
class Hr extends ne {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(e) {
    e && e !== f ? this.element.setAttribute(this.name, Z_) : this.element.removeAttribute(this.name);
  }
}
class Lr extends ne {
  constructor(e, r, o, _, a) {
  ...
  _$AI(e, r = this) {
    var o;
    if ((e = (o = R(this, e, r, 0)) !== null && o !== void 0 ? o : f) === M)
      return;
    const _ = this._$AH, a = e === f && _ !== f || e.capture !== _.capture || e.once !== _.once || e.passive !== _.passive, i = e !== f && (_ === f || a);
...
const K_ = { O: Be, P: x, A: ct, C: 1, M: Tr, L: Fr, R: Sr, D: R, I: G, V: ne, H: Hr, N: Lr, U: Er, F: Ur }, Et = Ce.litHtmlPolyfillSupport;
Et == null || Et(oe, G), ((ze = Ce.litHtmlVersions) !== null && ze !== void 0 ? ze : Ce.litHtmlVersions = []).push("2.8.0");
const Y_ = (t, e, r) => {
  var o, _;
  ...
  if (i === void 0) {
    ...
    a._$litPart$ = i = new G(e.insertBefore(te(), n), n, void 0, r ?? {});
  }
  return i._$AI(t), i;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pr = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, J_ = (t) => (...e) => ({ _$litDirective$: t, values: e });
class $r {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Q_ } = K_, Ht = () => document.createComment(""), Z = (t, e, r) => {
  var o;
  const _ = t._$AA.parentNode, a = e === void 0 ? t._$AB : e._$AA;
  if (r === void 0) {
    const i = _.insertBefore(Ht(), a), n = _.insertBefore(Ht(), a);
    r = new Q_(i, n, t, t.options);
  } else {
  ...
  return r;
}, L = (t, e, r = t) => (t._$AI(e, r), t), ea = {}, ta = (t, e = ea) => t._$AH = e, ra = (t) => t._$AH, je = (t) => {
  var e;
...
const Lt = (t, e, r) => {
  ...
  for (let _ = e; _ <= r; _++)
    o.set(t[_], _);
  return o;
}, oa = J_(class extends $r {
  constructor(t) {
    if (super(t), t.type !== Pr.CHILD)
  ...
  update(t, [e, r, o]) {
    var _;
    const a = ra(t), { values: i, keys: n } = this.ct(e, r, o);
    if (!Array.isArray(a))
      return this.ut = n, i;
    const s = (_ = this.ut) !== null && _ !== void 0 ? _ : this.ut = [], d = [];
    let u, l, p = 0, c = a.length - 1, v = 0, h = i.length - 1;
    for (; p <= c && v <= h; )
      if (a[p] === null)
        p++;
      else if (a[c] === null)
        ...
        d[h] = L(a[p], i[h]), Z(t, d[h + 1], a[p]), p++, h--;
      else if (s[c] === n[v])
        d[v] = L(a[c], i[v]), Z(t, a[p], a[c]), c--, v++;
      else if (u === void 0 && (u = Lt(n, v, h), l = Lt(s, p, c)), u.has(s[p]))
        if (u.has(s[c])) {
          const m = l.get(n[v]), se = m !== void 0 ? a[m] : null;
          if (se === null) {
            const Te = Z(t, a[p]);
            L(Te, i[v]), d[v] = Te;
          } else
            d[v] = L(se, i[v]), Z(t, a[p], se), a[m] = null;
          v++;
        } else
          je(a[c]), c--;
      else
...
class Ut extends $r {
  constructor(e) {
    if (super(e), this.et = f, e.type !== Pr.CHILD)
...
const K = (t, ...e) => {
  const r = S("LitStatic");
  return (r ? r.html : q_)(t, ...e);
}, Ie = (t, ...e) => {
  const r = S("LitStatic");
  return (r ? r.svg : X_)(t, ...e);
}, _a = (t, e, r, o, _) => {
  const a = S("OpenUI5Enablement");
  a && !o && (t = a.wrapTemplateResultInBusyMarkup(K, _.host, t)), typeof r == "string" ? t = K`<style>${r}</style>${t}` : Array.isArray(r) && r.length && (t = K`${r.map((i) => K`<link type="text/css" rel="stylesheet" href="${i}">`)}${t}`), Y_(t, e, _);
}, Ga = (t, e, r) => {
  const o = S("LitStatic");
  if (o)
  ...
  SINGLE_QUOTE: 222,
  BACKSLASH: 226
}, aa = (t) => (t.key ? t.key === "Enter" : t.keyCode === F.ENTER) && !E(t), Pt = (t) => (t.key ? t.key === "Spacebar" || t.key === " " : t.keyCode === F.SPACE) && !E(t), qa = (t) => (t.key ? t.key === "ArrowLeft" || t.key === "Left" : t.keyCode === F.ARROW_LEFT) && !E(t), Xa = (t) => (t.key ? t.key === "ArrowRight" || t.key === "Right" : t.keyCode === F.ARROW_RIGHT) && !E(t), Za = (t) => (t.key ? t.key === "ArrowUp" || t.key === "Up" : t.keyCode === F.ARROW_UP) && !E(t), Ka = (t) => (t.key ? t.key === "ArrowDown" || t.key === "Down" : t.keyCode === F.ARROW_DOWN) && !E(t), Ya = (t) => (t.key ? t.key === "Home" : t.keyCode === F.HOME) && !E(t), Ja = (t) => (t.key ? t.key === "End" : t.keyCode === F.END) && !E(t), E = (t) => t.shiftKey || t.altKey || ia(t), ia = (t) => !!(t.metaKey || t.ctrlKey), na = (t, e = {}) => (r) => {
...
A.set("SAP-icons", {
  legacy: T.SAPIconsV4,
  sap_horizon: T.SAPIconsV5
});
A.set("tnt", {
  legacy: T.SAPIconsTNTV2,
  sap_horizon: T.SAPIconsTNTV3
});
A.set("business-suite", {
  legacy: T.SAPBSIconsV1,
  sap_horizon: T.SAPBSIconsV2
});
const sa = (t, e) => {
  if (A.has(t)) {
    A.set(t, { ...e, ...A.get(t) });
  ...
  const e = p_() ? "legacy" : "sap_horizon";
  return A.has(t) ? A.get(t)[e] : t;
}, da = /* @__PURE__ */ new Map(), ca = (t) => da.get(t), Rr = (t) => {
  const e = ca(Ae());
  return !t && e ? Mr(e) : $t(t || "SAP-icons");
}, la = typeof document > "u", ua = () => {
  if (la)
    return Q;
  const t = navigator.languages, e = () => navigator.language;
  return t && t[0] || e() || Q;
}, pa = new I(), va = "languageChange", ha = (t) => {
  pa.attachEvent(va, t);
};
let Ve, ot;
const ma = () => (Ve === void 0 && (Ve = Ao()), Ve), fa = (t) => {
  ot = t;
}, ga = () => (ot === void 0 && fa(Io()), ot), ba = /^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;
class Nr {
  constructor(e) {
    const r = ba.exec(e.replace(/_/g, "-"));
    if (r === null)
      throw new Error(`The given language ${e} does not adhere to BCP-47.`);
    this.sLocaleId = e, this.sLanguage = r[1] || Q, this.sScript = r[2] || "", this.sRegion = r[3] || "", this.sVariant = r[4] && r[4].slice(1) || null, this.sExtension = r[5] && r[5].slice(1) || null, this.sPrivateUse = r[6] || null, this.sLanguage && (this.sLanguage = this.sLanguage.toLowerCase()), this.sScript && (this.sScript = this.sScript.toLowerCase().replace(/^[a-z]/, (o) => o.toUpperCase())), this.sRegion && (this.sRegion = this.sRegion.toUpperCase());
  }
  getLanguage() {
...
const Ge = /* @__PURE__ */ new Map(), Dr = (t) => (Ge.has(t) || Ge.set(t, new Nr(t)), Ge.get(t)), Mt = (t) => {
  try {
  ...
  const e = ma();
  return e ? Dr(e) : Mt(ua());
}, Ca = /^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?((?:-[0-9A-Z]{5,8}|-[0-9][0-9A-Z]{3})*)((?:-[0-9A-WYZ](?:-[0-9A-Z]{2,8})+)*)(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i, Rt = /(?:^|-)(saptrc|sappsd)(?:-|$)/i, Ba = {
  he: "iw",
  yi: "ji",
  nb: "no",
  sr: "sh"
  ...
  if (!t)
    return O;
  if (typeof t == "string" && (e = Ca.exec(t.replace(/_/g, "-")))) {
    let r = e[1].toLowerCase(), o = e[3] ? e[3].toUpperCase() : void 0;
    const _ = e[2] ? e[2].toLowerCase() : void 0, a = e[4] ? e[4].slice(1) : void 0, i = e[6];
    return r = Ba[r] || r, i && (e = Rt.exec(i)) || a && (e = Rt.exec(a)) ? `en_US_${e[1].toLowerCase()}` : (r === "zh" && !o && (_ === "hans" ? o = "CN" : _ === "hant" && (o = "TW")), r + (o ? "_" + o + (a ? "_" + a.replace("-", "_") : "") : ""));
  }
  return O;
}, wa = (t) => {
  if (!t)
...
}, Nt = /* @__PURE__ */ new Set(), Dt = /* @__PURE__ */ new Set(), lt = /* @__PURE__ */ new Map(), Xe = /* @__PURE__ */ new Map(), Or = /* @__PURE__ */ new Map(), Ot = (t, e) => {
  lt.set(t, e);
}, ya = (t) => lt.get(t), zr = (t, e) => {
  const r = `${t}/${e}`;
  return Or.has(r);
}, Sa = (t, e) => {
  const r = `${t}/${e}`, o = Or.get(r);
  return o && !Xe.get(r) && Xe.set(r, o(e)), Xe.get(r);
}, xa = (t) => {
  Nt.has(t) || (console.warn(
...
}, zt = (t, e) => e !== Q && !zr(t, e), Wr = async (t) => {
  const e = qe().getLanguage(), r = qe().getRegion(), o = qe().getVariant();
  let _ = e + (r ? `-${r}` : "") + (o ? `-${o}` : "");
  if (zt(t, _))
    for (_ = ka(_); zt(t, _); )
      _ = wa(_);
  ...
  try {
    const i = await Sa(t, _);
    Ot(t, i);
  } catch (i) {
    const n = i;
    Dt.has(n.message) || (Dt.add(n.message), console.error(n.message));
  }
};
ha((t) => {
  const e = [...lt.keys()];
  return Promise.all(e.map(Wr));
});
const Aa = /('')|'([^']+(?:''[^']*)*)(?:'|$)|\{([0-9]+(?:\s*,[^{}]*)?)\}|[{}]/g, Ia = (t, e) => (e = e || [], t.replace(Aa, (r, o, _, a, i) => {
  if (o)
    return "'";
  if (_)
    return _.replace(/''/g, "'");
...
const Fa = (t) => {
  ...
  const e = new Ta(t);
  return Ze.set(t, e), e;
}, Ea = async (t) => (await Wr(t), Fa(t)), Ha = "legacy", Wt = /* @__PURE__ */ new Map(), jr = j("SVGIcons.registry", /* @__PURE__ */ new Map()), Ke = j("SVGIcons.promises", /* @__PURE__ */ new Map()), jt = "ICON_NOT_FOUND", La = async (t) => {
  if (!Ke.has(t)) {
    if (!Wt.has(t))
  ...
  let e;
  return [t, e] = t.split("/").reverse(), t = t.replace("icon-", ""), e && (e = Mr(e)), { name: t, collection: e };
}, Pa = (t) => {
  const { name: e, collection: r } = Vr(t);
  return _t(r, e);
}, $a = async (t) => {
  const { name: e, collection: r } = Vr(t);
  let o = jt;
  ...
  return _ || (Array.isArray(o) ? o.forEach((a) => {
    Vt(a), sa(r, { [a.themeFamily || Ha]: a.collection });
  }) : Vt(o), _t(r, e));
}, _t = (t, e) => {
  const r = `${Rr(t)}/${e}`;
  return jr.get(r);
...
function Ma(t, e, r) {
  return K`<svg class="ui5-icon-root" part="root" tabindex="${y(this._tabIndex)}" dir="${y(this._dir)}" viewBox="${y(this.viewBox)}" role="${y(this.effectiveAccessibleRole)}" focusable="false" preserveAspectRatio="xMidYMid meet" aria-label="${y(this.effectiveAccessibleName)}" aria-hidden=${y(this.effectiveAriaHidden)} xmlns="http://www.w3.org/2000/svg" @focusin=${this._onfocusin} @focusout=${this._onfocusout} @keydown=${this._onkeydown} @keyup=${this._onkeyup}>${Oa.call(this, t, e, r)}</svg>`;
}
function Ra(t, e, r) {
  return Ie`<title id="${y(this._id)}-tooltip">${y(this.effectiveAccessibleName)}</title>`;
}
function Na(t, e, r) {
  return Ie`${y(this.customSvg)}`;
}
function Da(t, e, r, o, _) {
  return Ie`<path d="${y(o)}"></path>`;
}
function Oa(t, e, r) {
  return Ie`${this.hasIconTooltip ? Ra.call(this, t, e, r) : void 0}<g role="presentation">${this.customSvg ? Na.call(this, t, e, r) : void 0}${oa(this.pathData, (o, _) => o._id || _, (o, _) => Da.call(this, t, e, r, o, _))}</g>`;
}
var at;
(function(t) {
...
const Va = "ICON_NOT_FOUND", qt = "presentation";
let b = class extends ie {
  ...
  _onkeydown(e) {
    this.interactive && (aa(e) && this.fireEvent("click"), Pt(e) && e.preventDefault());
  }
  _onkeyup(e) {
    this.interactive && Pt(e) && this.fireEvent("click");
  }
  /**
  ...
  */
  ...
  get isDecorative() {
    return this.effectiveAccessibleRole === qt;
  }
  get effectiveAccessibleRole() {
    return this.accessibleRole ? this.accessibleRole : this.interactive ? "button" : this.effectiveAccessibleName ? "img" : qt;
  }
...
B([
  w({ type: Gt, defaultValue: Gt.Default })
], b.prototype, "design", void 0);
B([
  w({ type: Boolean })
], b.prototype, "interactive", void 0);
B([
  w()
], b.prototype, "name", void 0);
B([
  w()
], b.prototype, "accessibleName", void 0);
B([
  w({ type: Boolean })
], b.prototype, "showTooltip", void 0);
B([
  w()
], b.prototype, "accessibleRole", void 0);
B([
  w()
], b.prototype, "ariaHidden", void 0);
B([
  w({ multiple: !0 })
], b.prototype, "pathData", void 0);
B([
  w({ type: Object, defaultValue: void 0, noAttribute: !0 })
], b.prototype, "accData", void 0);
B([
  w({ type: Boolean })
], b.prototype, "focused", void 0);
B([
  w({ type: Boolean })
], b.prototype, "invalid", void 0);
B([
  w({ noAttribute: !0, defaultValue: void 0 })
], b.prototype, "effectiveAccessibleName", void 0);
b = B([
  V_({
    tag: "ui5-icon",
    languageAware: !0,
...
b.define();
const ei = b, ti = { packageName: "@udex/web-components", fileName: "themes/sap_horizon/parameters-bundle.css.ts", content: "" };
export {
  ei as I,
  ie as U,
  lr as a,
